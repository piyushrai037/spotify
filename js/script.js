...
async function getSongs(folder) {
    ...
    for (let index = 0; index < as.length; index++) {
        ...
        if (element.href.endsWith(".mp3")) {
            ...
            let songPath = url.pathname.split(`/songs/${folder}/`)[1];
...
async function displayAlbums() {
    ...
    let a = await fetch(`https://github.com/piyushrai037/spotify/tree/accce1d7e4a154f906453d794634e491ce1b52d2/songs/`);
    if (!a.ok) {
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (e.href.includes("/songs/") && !e.href.includes(".htaccess")) {
            ...
            try {
                ...
                if (!metadata.ok) throw new Error("Metadata not found");
                ...
                console.log(`Skipping ${folder} due to missing metadata`);
            }
        }
    }
